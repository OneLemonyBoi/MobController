...
public class GlowingTemptGoal extends Goal {
   ...
   public GlowingTemptGoal(CreatureEntity creatureIn, double speedIn, Ingredient temptItemsIn, boolean scaredByPlayerMovementIn) {
      this(creatureIn, speedIn, scaredByPlayerMovementIn, temptItemsIn);
   }

   public GlowingTemptGoal(CreatureEntity creatureIn, double speedIn, boolean scaredByPlayerMovementIn, Ingredient temptItemsIn) {
   ...
   public boolean shouldExecute() {
      if (this.creature.getActivePotionEffect(Effects.GLOWING) == null) {
         return false;
      }
